                            ...
                            <form onSubmit={handleFormSubmit}>
                                <div class="w-full  px-2 mb-4">
                                    <div class="relative">
                                        <input
                                            ...
                                            id="name"
                                            name="name"
                                            class="block  px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-700  rounded-md border border-gray-100 appearance-none focus:outline-none peer"
                                            placeholder=" "
                                ...
                                <div class="w-full px-2 mb-4">
                                    <div class="relative">
                                        <textarea
                                            id="interest"
                                            name="message"
                                            class="border border-gray-100  block w-full py-2 px-4 placeholder-gray-700 rounded-md text-gray-700 focus:outline-none"
                                            rows="8"
                                ...
                                <div className="flex flex-col  items-center gap-5 text-gray-500">
                                    ...
                                    <p className="mb-5">
                                        ...
                                        <span className="text-gray-700"> Privacy Policy</span> and <span className="text-gray-700">Terms of Service </span>
                                        apply.
                                    </p>
