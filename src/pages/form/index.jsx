            ...
            <div className="grid grid-cols-12 gap-4 px-4 md:px-0">
                ...
                <div className="col-span-12 md:col-span-8 text-center px-6 py-14 rounded-lg  shadow-lg">
                    ...
                    <div className="flex w-full justify-center gap-4">
                        <div className="pt-7">
                            <button onClick={openPartner} className="bg-black w-24 h-24 text-xs text-[#C6C6C6] tracking-wider font-bold rounded-full focus:outline-none focus:shadow-outline" type="button">
                        ...
                        <div className="pt-7">
                            <button onClick={openInvest} className="bg-black w-24 h-24 text-xs text-[#C6C6C6] tracking-wider font-bold rounded-full focus:outline-none focus:shadow-outline" type="button">
